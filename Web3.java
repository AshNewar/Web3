class Car{
    ...
    public double time_to_collision(Car car2) {
        int Xdistance = car2.x-this.x;
        int Ydistance = car2.y-this.y;
        int Zdistance = car2.z-this.z;
        double speed = this.speed - car2.speed;
        return ((Math.sqrt(Xdistance * Xdistance+ Ydistance * Ydistance + Zdistance*Zdistance) )/ Math.abs(speed));
    }
    
}
public class masterweb3 {
    public static void main(String[] args) {
        Car car1=new Car("Maruti","alto",2022,20,5,10,13);
        Car car2=new Car("Mercedes","Benz",2023,10,10,15,12);
        car1.accelerate(3);
        car2.accelerate(5);
